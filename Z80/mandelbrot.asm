...
.check_fraction:
   ...
   jp nz,.dec_i
.do_it:
   call fp_subtract           ; C = X^2 - Y^2
   FP_TCA                     ; A = C (X^2 - Y^2)
   FP_LDB (mand_x0)           ; B = X0
   call fp_add                ; C = X^2 - Y^2 + X0
